...
import json
import random
from base import TRIALS, IMPAIRMENTS
...
class Character:
    def __init__(self, filename):
        ...
        self._LE = 5 + 2 * self.KO + raw_data.get("LE_BONUS", 0)
...
if __name__ == "__main__":
    daria = Character("daria.json")
    while True:
        trial = random.choice(list(TRIALS))
        print(daria.do_trial(trial))
